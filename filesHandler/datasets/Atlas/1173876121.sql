...
CREATE TABLE hlt_trigger_menu ( 
	...
	htm_name 		VARCHAR2(15) BINARY NOT NULL,
...
CREATE TABLE hlt_trigger_chain (
	...
	htc_name 		VARCHAR2(20) BINARY NOT NULL,
	htc_version 		NUMBER(11)	NOT NULL, 
	htc_lower_chain_name 	VARCHAR2(20) BINARY NOT NULL,
...
CREATE TABLE hlt_trigger_element ( 
	...
	hte_name          VARCHAR2(30) BINARY NOT NULL,
...
CREATE TABLE hlt_te_to_te (
	...
	hte2te_trigger_element_counter	NUMBER(3)	NOT NULL,
