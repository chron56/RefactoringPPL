-- $Id: combined_schema.sql,v 1.71 2008/07/23 12:45:33 pbell Exp $
-- $Revision: 1.71 $
---------------------------------------------------------
...
-- hrs2rc_component_type: 0 - unasigned (used for Merge Rule), 1 - online component, 2 - offline component
