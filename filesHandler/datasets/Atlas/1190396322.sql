...
CREATE TABLE l1_tm_to_tt ( 
	...
	l1tm2tt_mon_name		VARCHAR2(25),
	l1tm2tt_multi			NUMBER(10),
	l1tm2tt_type			VARCHAR2(6),  
	l1tm2tt_identifier		VARCHAR2(25),  
...
CREATE TABLE hlt_parameter (
  ...
  hpa_value         CLOB	NOT NULL,
-- at least one parameter in the egamma slice is longer than 4000 chars
