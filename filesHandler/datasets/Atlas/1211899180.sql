-- $Id: combined_schema.sql,v 1.65 2008/05/27 14:39:40 pbell Exp $
-- $Revision: 1.65 $
---------------------------------------------------------
...
-- Used to assign private tools to algorithms
-- The tools can only be reached via the cp-cp link, and the "parent" cp will be linked
-- to a TE via the TE-CP link. 
CREATE TABLE hlt_cp_to_cp (
 	hcp2cp_id		NUMBER(10) 	NOT NULL,
 	hcp2cp_algo_comp_id	NUMBER(10) 	NOT NULL,
 	hcp2cp_tool_comp_id	NUMBER(10) 	NOT NULL,
	...
	CONSTRAINT	  	hcp2cp_pk	PRIMARY KEY (hcp2cp_id),
 	CONSTRAINT	  	hcp2cp_fk_acp	FOREIGN KEY (hcp2cp_algo_comp_id)
   						REFERENCES hlt_component (hcp_id),
 	CONSTRAINT	  	hcp2cp_fk_tcp	FOREIGN KEY (hcp2cp_tool_comp_id)
   						REFERENCES hlt_component (hcp_id)
	);
