-- $Id: combined_schema.sql,v 1.76 2008/08/01 08:32:46 pbell Exp $
-- $Revision: 1.76 $
---------------------------------------------------------
...
CREATE TABLE trigger_schema (
	...
	ts_trigdb_tag			VARCHAR2(50)	NOT NULL,
	ts_trigtool_tag			VARCHAR2(50)	NOT NULL,
...
CREATE TABLE tt_users (
	tt_level VARCHAR2(50) NOT NULL,
	tt_user  VARCHAR2(50) NOT NULL,
	tt_password VARCHAR2(50) NOT NULL
);
...
CREATE TABLE l1_prescale_set_alias (
	...
	l1pa_alias 			VARCHAR2(50)  	NOT NULL,
...
CREATE TABLE hlt_prescale_set_alias (
  ...
  hpsa_alias              VARCHAR2(50)    NOT NULL,
...
CREATE TABLE trigger_alias (
	...
	tal_trigger_alias           VARCHAR2(50) NOT NULL,
...
CREATE TABLE l1_muctpi_info (
	...
	l1mi_name 		VARCHAR2(50) 	NOT NULL,
...
CREATE TABLE l1_dead_time ( 
	...
	l1dt_name 		VARCHAR2(50) 	NOT NULL,
...
CREATE TABLE l1_prescaled_clock (
	...
	l1pc_name 		VARCHAR2(50) 	NOT NULL,
...
CREATE TABLE l1_jet_input (
	...
	l1ji_name 		VARCHAR2(50) 	NOT NULL,
...
CREATE TABLE l1_calo_sin_cos (
	...
	l1csc_name 		VARCHAR2(50) 	NOT NULL,
...
CREATE TABLE l1_bunch_group_set (
	...
	l1bgs_name 		VARCHAR2(50)	NOT NULL,
...
CREATE TABLE l1_bunch_group (
	...
	l1bg_name 		VARCHAR2(50)	NOT NULL,
...
CREATE TABLE l1_ctp_files ( 
	...
	l1cf_name 		VARCHAR2(50) 	NOT NULL,
...
CREATE TABLE l1_ctp_smx (
	...
	l1smx_name 		VARCHAR2(50)	NOT NULL,
...
CREATE TABLE l1_trigger_menu (
	...
	l1tm_name 		VARCHAR2(50) 	NOT NULL,
	l1tm_version 		NUMBER(11)	NOT NULL,
	l1tm_phase 		VARCHAR2(50) 	NOT NULL,
...
CREATE TABLE l1_trigger_item (
	...
	l1ti_name 		VARCHAR2(50) 	NOT NULL,
...
CREATE TABLE l1_trigger_threshold (
	...
	l1tt_name 		VARCHAR2(50) 	NOT NULL,
...
CREATE TABLE l1_trigger_threshold_value (
	...
	l1ttv_name 		VARCHAR2(50) 	NOT NULL,
	l1ttv_version 		NUMBER(11)	NOT NULL,
	l1ttv_type		VARCHAR2(10)	NOT NULL,
	l1ttv_pt_cut 		VARCHAR2(10) 	NOT NULL,
...
CREATE TABLE l1_calo_info (
        ...
        l1ci_name	                VARCHAR2(50)    NOT NULL,
        l1ci_version                    NUMBER(11)      NOT NULL,
	l1ci_global_scale		VARCHAR2(10)   	NOT NULL,
...
CREATE TABLE l1_muon_threshold_set (
	...
	l1mts_name 		       	VARCHAR2(50) 	NOT NULL,
	l1mts_version 		       	NUMBER(11)	NOT NULL,
	l1mts_rpc_available	       	CHAR   		NOT NULL,
	l1mts_rpc_available_online     	CHAR 		NOT NULL,
	l1mts_rpc_set_ext_id 		NUMBER(10) 	NOT NULL,
	l1mts_rpc_pt1_ext_id 		NUMBER(10) 	NOT NULL,
	l1mts_rpc_pt2_ext_id 		NUMBER(10) 	NOT NULL,
	l1mts_rpc_pt3_ext_id 		NUMBER(10) 	NOT NULL,
	l1mts_rpc_pt4_ext_id 		NUMBER(10) 	NOT NULL,
	l1mts_rpc_pt5_ext_id 		NUMBER(10) 	NOT NULL,
	l1mts_rpc_pt6_ext_id 		NUMBER(10) 	NOT NULL,
	l1mts_tgc_available  		CHAR 		NOT NULL, 
	l1mts_tgc_available_online 	CHAR 		NOT NULL,
        l1mts_tgc_set_ext_id 		NUMBER(10) 	NOT NULL,
        l1mts_tgc_pt1_ext_id 		NUMBER(10) 	NOT NULL,
        l1mts_tgc_pt2_ext_id 		NUMBER(10) 	NOT NULL,
        l1mts_tgc_pt3_ext_id 		NUMBER(10) 	NOT NULL,
        l1mts_tgc_pt4_ext_id 		NUMBER(10) 	NOT NULL,
        l1mts_tgc_pt5_ext_id 		NUMBER(10) 	NOT NULL,
        l1mts_tgc_pt6_ext_id 		NUMBER(10) 	NOT NULL,
...
CREATE TABLE l1_prescale_set (
	...
	l1ps_name		VARCHAR2(65)	NOT NULL,
	l1ps_version		NUMBER(11)	NOT NULL,
        l1ps_comment		VARCHAR2(200)	,
	l1ps_lumi		VARCHAR2(10)	NOT NULL,
...
CREATE TABLE l1_tm_to_ps ( 
	l1tm2ps_id 			NUMBER(10) 	NOT NULL,
	l1tm2ps_trigger_menu_id 	NUMBER(10) 	NOT NULL,
	l1tm2ps_prescale_set_id 	NUMBER(10) 	NOT NULL,
	l1tm2ps_username 		VARCHAR2(50)	,
	l1tm2ps_modified_time		TIMESTAMP	,
	l1tm2ps_used			CHAR		NOT NULL,
...
CREATE TABLE l1_tm_to_tt_mon (
	...
	l1tm2ttm_name			VARCHAR2(50)	NOT NULL,
	l1tm2ttm_internal_counter	NUMBER(3)	NOT NULL,
	l1tm2ttm_bunch_group_id		NUMBER(10)	NOT NULL,
...
CREATE TABLE l1_master_table (
	...
	l1mt_name		VARCHAR2(50)	NOT NULL,
  ...
  l1mt_muon_threshold_set_id   NUMBER(10) NOT NULL,
...
CREATE TABLE hlt_component (
	hcp_id       NUMBER(10)      NOT NULL,
	hcp_name     VARCHAR2(200)   NOT NULL,
	hcp_version  NUMBER(11)      NOT NULL,
	hcp_alias    VARCHAR2(200)   NOT NULL,
	hcp_type     VARCHAR2(200)   NOT NULL,
	hcp_py_name  VARCHAR2(200)   NOT NULL,
	hcp_py_package    VARCHAR2(200)   NOT NULL,
...
CREATE TABLE hlt_cp_to_cp (
 	hcp2cp_id		NUMBER(10) 	NOT NULL,
 	hcp2cp_parent_comp_id	NUMBER(10) 	NOT NULL,
 	hcp2cp_child_comp_id	NUMBER(10) 	NOT NULL,
	hcp2cp_username		VARCHAR2(50)	,
	hcp2cp_modified_time	TIMESTAMP	,
	hcp2cp_used		CHAR		default 0 NOT NULL,
...
CREATE TABLE hlt_release (
	hre_id			NUMBER(10) NOT NULL,
	hre_name 		VARCHAR2(200)	NOT NULL,
	hre_base 		VARCHAR2(200)	NOT NULL,
	hre_patch_1 		VARCHAR2(200)	NOT NULL,
	hre_patch_2 		VARCHAR2(200)	NOT NULL,
...
CREATE TABLE hlt_trigger_menu ( 
	...
	htm_name 		VARCHAR2(50)    NOT NULL,
	htm_version 		NUMBER(11)      NOT NULL,
	htm_phase 		VARCHAR2(50) 	NOT NULL,
...
CREATE TABLE hlt_trigger_chain (
  ...
  htc_name               VARCHAR2(50)  NOT NULL,
  htc_version            NUMBER(11)    NOT NULL,
  htc_user_version       NUMBER(11)    NOT NULL,
  htc_comment		 VARCHAR2(50)	, 
  htc_chain_counter      NUMBER(10)    NOT NULL,
  htc_lower_chain_name   VARCHAR2(50)  NOT NULL,
...
CREATE TABLE hlt_prescale (
  ...
  hpr_prescale        	VARCHAR2(50)   	NOT NULL,
  hpr_pass_through_rate VARCHAR2(50)   	NOT NULL,
...
CREATE TABLE hlt_tm_to_ps ( 
	htm2ps_id 		NUMBER(10) 	NOT NULL,
	htm2ps_trigger_menu_id 	NUMBER(10) 	NOT NULL,
	htm2ps_prescale_set_id  NUMBER(10) 	NOT NULL,
	htm2ps_username 	VARCHAR2(50)	,
	htm2ps_modified_time	TIMESTAMP	,
	htm2ps_used		CHAR		NOT NULL,
...
CREATE TABLE hlt_trigger_stream (
  ...
  htr_name               VARCHAR2(50)  NOT NULL,
  htr_description        VARCHAR2(200) NOT NULL,
  htr_type               VARCHAR2(50)  NOT NULL,
...
CREATE TABLE hlt_te_to_te (
  ...
  hte2te_te_inp_id           VARCHAR2(100) NOT NULL,
...
CREATE TABLE HLT_RULE_SET (
  hrs_id                 NUMBER(10)    NOT NULL,
  hrs_name               VARCHAR2(50)  NOT NULL,
  hrs_version            NUMBER(11)    NOT NULL,
  hrs_username           VARCHAR2(50),
  hrs_modified_time      TIMESTAMP,
  hrs_used               CHAR          NOT NULL,
...
CREATE TABLE HLT_RULE (
  hru_id                 NUMBER(10)    NOT NULL,
  hru_name               VARCHAR2(50)  NOT NULL,
  hru_version            NUMBER(11)    NOT NULL,
  hru_type               NUMBER(1)     NOT NULL,
  hru_username           VARCHAR2(50),
  hru_modified_time      TIMESTAMP,
  hru_used               CHAR          NOT NULL,
...
CREATE TABLE HLT_RULE_COMPONENT (
  hrc_id                NUMBER(10)      NOT NULL,
  hrc_name              VARCHAR2(200)   NOT NULL,
  hrc_version           NUMBER(11)      NOT NULL,
  hrc_alias             VARCHAR2(200)   NOT NULL,
  hrc_type              VARCHAR2(50)    NOT NULL,
  hrc_py_name           VARCHAR2(200)   NOT NULL,
  hrc_py_package        VARCHAR2(200)   NOT NULL,
  hrc_username          VARCHAR2(50),
  hrc_modified_time     TIMESTAMP,
  hrc_used              CHAR default 0  NOT NULL,
...
CREATE TABLE HLT_RULE_PARAMETER (
  hrp_id              NUMBER(10)      NOT NULL,
  hrp_name            VARCHAR2(50)    NOT NULL,
  hrp_op              VARCHAR2(30)    NOT NULL,
  hrp_value           VARCHAR2(4000)  NOT NULL,
  hrp_username        VARCHAR2(50),
  hrp_modified_time   TIMESTAMP,
  hrp_used            CHAR      default 0 NOT NULL,
...
CREATE TABLE HLT_HRE_TO_HRS (
  hre2rs_id                      NUMBER(10)   NOT NULL,
  hre2rs_release_id                 NUMBER(10),
  hre2rs_rule_set_id             NUMBER(10),
  hre2rs_username                VARCHAR2(50),
  hre2rs_modified_time           TIMESTAMP,
  hre2rs_used                    CHAR         NOT NULL,
  CONSTRAINT hre2rs_pk           PRIMARY KEY (hre2rs_id),
  CONSTRAINT hre2rs_fk_ru        FOREIGN KEY (hre2rs_release_id)   REFERENCES HLT_RELEASE(hre_id),
  CONSTRAINT hre2rs_fk_rs        FOREIGN KEY (hre2rs_rule_set_id)  REFERENCES HLT_RULE_SET(hrs_id)
);
...
CREATE TABLE HLT_HRS_TO_HRU (
  hrs2ru_id                      NUMBER(10)   NOT NULL,
  hrs2ru_rule_set_id             NUMBER(10),
  hrs2ru_rule_id                 NUMBER(10),
  hrs2ru_rule_counter            NUMBER(10)  NOT NULL,
  hrs2ru_username                VARCHAR2(50),
  hrs2ru_modified_time           TIMESTAMP,
  hrs2ru_used                    CHAR         NOT NULL,
  CONSTRAINT hrs2ru_pk           PRIMARY KEY (hrs2ru_id),
  CONSTRAINT hrs2ru_fk_rs        FOREIGN KEY (hrs2ru_rule_set_id)  REFERENCES HLT_RULE_SET(hrs_id),
  CONSTRAINT hrs2ru_fk_ru        FOREIGN KEY (hrs2ru_rule_id) REFERENCES HLT_RULE(hru_id)
);
...
CREATE TABLE HLT_HRU_TO_HRC (
  ...
  hru2rc_used                    CHAR         NOT NULL,
  CONSTRAINT hru2rc_pk           PRIMARY KEY (hru2rc_id),
  CONSTRAINT hru2rc_fk_ru        FOREIGN KEY (hru2rc_rule_id) REFERENCES HLT_RULE(hru_id),
  CONSTRAINT hru2rc_fk_rc        FOREIGN KEY (hru2rc_component_id) REFERENCES HLT_RULE_COMPONENT(hrc_id),
...
CREATE TABLE HLT_HRC_TO_HRP (
  hrc2rp_id                      NUMBER(10)   NOT NULL,
  hrc2rp_component_id            NUMBER(10),
  hrc2rp_parameter_id            NUMBER(10),
  hrc2rp_username                VARCHAR2(50),
  hrc2rp_modified_time           TIMESTAMP,
  hrc2rp_used                    CHAR         NOT NULL,
  CONSTRAINT hrc2rp_pk           PRIMARY KEY (hrc2rp_id),
  CONSTRAINT hrc2rp_fk_rc        FOREIGN KEY (hrc2rp_component_id) REFERENCES HLT_RULE_COMPONENT(hrc_id),
  CONSTRAINT hrc2rp_fk_rp        FOREIGN KEY (hrc2rp_parameter_id) REFERENCES HLT_RULE_PARAMETER(hrp_id)
);
...
CREATE TABLE HLT_SMT_TO_HRE (
  ...
  smt2re_used                    CHAR         NOT NULL,
  CONSTRAINT smt2re_pk           PRIMARY KEY (smt2re_id),
  CONSTRAINT smt2re_fk_smt       FOREIGN KEY (smt2re_super_master_table_id)  REFERENCES SUPER_MASTER_TABLE(smt_id),
  CONSTRAINT smt2re_fk_re        FOREIGN KEY (smt2re_release_id)             REFERENCES HLT_RELEASE(hre_id)
);
...
CREATE TABLE trigger_log (
	...
	tlog_short		VARCHAR2(50),
	tlog_message		VARCHAR2(1000),
