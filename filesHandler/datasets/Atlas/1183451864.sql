...
DROP TABLE l1_prescale_set_alias;

-- drop trigger alias table
DROP TABLE trigger_alias;
...
CREATE TABLE l1_prescale_set_alias (
	...
	l1pa_status			NUMBER(2)	NOT NULL,
	CONSTRAINT 			l1pa_pk		PRIMARY KEY(l1pa_id)
	);

-- trigger alias preseneted to the shift user
...
CREATE TABLE l1_trigger_type (
	...
	l1tty_status		NUMBER(2)	NOT NULL,
...
CREATE TABLE l1_calo_sin_cos (
	...
	l1csc_status		NUMBER(2)	NOT NULL,
...
CREATE TABLE l1_bunch_group_set (
	...
	l1bgs_status		NUMBER(2)	NOT NULL,
...
CREATE TABLE l1_ctp_smx (
	...
	l1smx_status		NUMBER(2)	NOT NULL,
...
CREATE TABLE l1_trigger_threshold_value (
	...
	l1ttv_status		NUMBER(2)	NOT NULL,
...
CREATE TABLE l1_muon_threshold_sets (
	...
	l1mts_status		NUMBER(2)	NOT NULL,
...
CREATE TABLE l1_tm_to_ti ( 
	...
	l1tm2ti_status			NUMBER(2)	NOT NULL,
...
CREATE TABLE l1_ti_to_tt ( 
	...
	l1ti2tt_status			NUMBER(2)	NOT NULL,
...
CREATE TABLE l1_tt_to_ttv (
	...
	l1tt2ttv_status				NUMBER(2)	NOT NULL,
...
CREATE TABLE l1_tm_to_tt_forced ( 
	...
	l1tm2ttf_status			NUMBER(2)	NOT NULL,
...
CREATE TABLE l1_tm_to_tt ( 
	...
	l1tm2tt_status			NUMBER(2)	NOT NULL,
...
CREATE TABLE l1_bgs_to_bg (
	...
	l1bg2bgs_status			NUMBER(2)	NOT NULL,
...
CREATE TABLE l1_bg_to_b (
	...
	l1bg2b_status			NUMBER(2)	NOT NULL,
...
CREATE TABLE l1_ci_to_csc (
	...
	l1ci2csc_status			  NUMBER(2)	  NOT NULL,
...
CREATE TABLE hlt_cp_to_pa (
	...
	hcp2pa_status		NUMBER(2)	NOT NULL,
...
CREATE TABLE hlt_st_to_cp (
	...
	hst2cp_status		NUMBER(2)	NOT NULL,
...
CREATE TABLE hlt_tm_to_tc ( 
	...
	htm2tc_status		NUMBER(2)	NOT NULL,
...
CREATE TABLE hlt_tc_to_ts ( 
	...
	htc2ts_status			NUMBER(2)	NOT NULL,
...
CREATE TABLE hlt_tc_to_tr (
  ...
  htc2tr_status			 NUMBER(2)	NOT NULL,
...
CREATE TABLE hlt_ts_to_te ( 
	...
	hts2te_used			CHAR		NOT NULL,
        hts2te_status			NUMBER(2)	NOT NULL,
...
CREATE TABLE hlt_te_to_cp (
	...
	hte2cp_status			NUMBER(2)	NOT NULL,		
...
CREATE TABLE hlt_te_to_te (
	...
	hte2te_status			NUMBER(2)	NOT NULL,
