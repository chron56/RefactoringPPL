-- $Id: combined_schema.sql,v 1.82 2009/03/24 13:39:12 stelzer Exp $
-- $Revision: 1.82 $
---------------------------------------------------------
...
INSERT INTO trigger_schema VALUES (8,"TrigDB-01-01-08","TriggerTool-01-20-03");
...
CREATE TABLE hlt_prescale_set_coll (
    ...
    CONSTRAINT       hpsc_pk            PRIMARY KEY (hpsc_run, hpsc_lb),
...
-- this table is not used any longer and should be removed
