...
DROP TABLE l1_muon_threshold_sets;
...
CREATE TABLE l1_muon_threshold_sets (
	...
	l1mts_version 		NUMBER(11,5)	NOT NULL,
...
CREATE TABLE hlt_parameter (
	...
	hpa_value		VARCHAR2(40000)	,
	hpa_username		VARCHAR2(15)	,
	hpa_modified_time	TIMESTAMP	,
	hpa_used		CHAR		NOT NULL default 0,
...
CREATE TABLE hlt_component (
	...
	hcp_used		CHAR		NOT NULL default 0,
...
CREATE TABLE hlt_cp_to_pa (
	...
	hcp2pa_used		CHAR		NOT NULL default 0,
...
CREATE TABLE hlt_setup (
	...
	hst_used		CHAR		NOT NULL default 0,
...
CREATE TABLE hlt_st_to_cp (
	...
	hst2cp_used		CHAR		NOT NULL default 0,
...
CREATE TABLE hlt_release (
	...
	hre_used		CHAR		NOT NULL default 0,
...
CREATE TABLE hlt_re_to_dl (
	...
	hre2dl_used		CHAR		NOT NULL default 0,
...
CREATE TABLE hlt_trigger_stream (
  htr_id                 NUMBER(10)   NOT NULL,
	htr_stream_name        VARCHAR2(40),
	htr_stream_description VARCHAR2(200),
	htr_stream_type        VARCHAR2(10),
  htr_obeyLB             VARCHAR2(5), 
	htr_username           VARCHAR2(15),
