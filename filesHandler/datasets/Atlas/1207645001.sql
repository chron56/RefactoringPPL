-- $Id: combined_schema.sql,v 1.52 2008/04/08 08:56:41 pbell Exp $
-- $Revision: 1.52 $
---------------------------------------------------------
...
DROP TABLE hlt_tc_to_tt PURGE;
DROP TABLE hlt_tt_to_tr PURGE;
--- PJB hack for first time:
...
DROP TABLE hlt_trigger_streamtag PURGE;
...
CREATE TABLE l1_trigger_type (
	...
	l1tty_name		VARCHAR2(50)	NOT NULL,
...
CREATE TABLE hlt_prescale (
  ...
  hpr_prescale        	FLOAT(24)    	NOT NULL,
  hpr_pass_through_rate FLOAT(24)    	NOT NULL,
...
CREATE TABLE hlt_trigger_type (
  hty_id                 NUMBER(10)   NOT NULL,
  hty_trigger_chain_id   NUMBER(10),
  hty_typebit            NUMBER(10),
  hty_username           VARCHAR2(50),
  hty_modified_time      TIMESTAMP,
  hty_used               CHAR         NOT NULL,
  CONSTRAINT hty_pk      PRIMARY KEY (hty_id),
  CONSTRAINT hty_fk_tc   FOREIGN KEY (hty_trigger_chain_id)  REFERENCES hlt_trigger_chain(htc_id)
);

-- this table constains the streamtag info
CREATE TABLE hlt_trigger_streamtag (
  htt_id                 NUMBER(10)    NOT NULL,
  htt_name        	 VARCHAR2(50)  NOT NULL,
...
CREATE TABLE hlt_tc_to_tt (
  htc2tt_id                      NUMBER(10)   NOT NULL,
  htc2tt_trigger_chain_id        NUMBER(10),
  htc2tt_trigger_streamtag_id    NUMBER(10),
  htc2tt_username                VARCHAR2(50),
  htc2tt_modified_time           TIMESTAMP,
  htc2tt_used                    CHAR         NOT NULL,
  CONSTRAINT htc2tt_pk           PRIMARY KEY (htc2tt_id),
  CONSTRAINT htc2tt_fk_tc        FOREIGN KEY (htc2tt_trigger_chain_id)  REFERENCES hlt_trigger_chain(htc_id),
  CONSTRAINT htc2tt_fk_tt        FOREIGN KEY (htc2tt_trigger_streamtag_id) REFERENCES hlt_trigger_streamtag(htt_id)
);

CREATE TABLE hlt_tt_to_tr (
  htt2tr_id                      NUMBER(10)   NOT NULL,
  htt2tr_trigger_streamtag_id    NUMBER(10),
  htt2tr_trigger_stream_id       NUMBER(10),
  htt2tr_trigger_stream_prescale NUMBER(10),
  htt2tr_username                VARCHAR2(50),
  htt2tr_modified_time           TIMESTAMP,
  htt2tr_used                    CHAR         NOT NULL,
  CONSTRAINT htt2tr_pk           PRIMARY KEY (htt2tr_id),
  CONSTRAINT htt2tr_fk_tt        FOREIGN KEY (htt2tr_trigger_streamtag_id)  REFERENCES hlt_trigger_streamtag(htt_id),
  CONSTRAINT htt2tr_fk_tr        FOREIGN KEY (htt2tr_trigger_stream_id) REFERENCES hlt_trigger_stream(htr_id)
);
