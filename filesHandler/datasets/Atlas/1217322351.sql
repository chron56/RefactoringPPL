-- $Id: combined_schema.sql,v 1.73 2008/07/29 09:05:51 pbell Exp $
-- $Revision: 1.73 $
---------------------------------------------------------
...
INSERT INTO trigger_schema VALUES (6,"NA","NA");
INSERT INTO trigger_schema VALUES (7,"NA","NA");
INSERT INTO trigger_schema VALUES (8,"NA","NA");
INSERT INTO trigger_schema VALUES (9,"TrigDb-00-01-02","WIP");
...
--	CONSTRAINT l1mt__fk_dt FOREIGN KEY (l1mt_dead_time_id) REFERENCES l1_dead_time(l1dt_id),
...
CREATE TABLE hlt_release (
	...
	hre_version		NUMBER(10)	NOT NULL,
